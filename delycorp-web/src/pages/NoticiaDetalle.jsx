    ...
    import './Noticias.css'; // Reusa el CSS
    ...
    return (
        ...
        <div className="news-hero" style={{height:'250px', padding:'40px 0'}}>
            ...
            <Link to="/noticias" style={{color:'white', textDecoration:'none', display:'flex', alignItems:'center', gap:'10px', justifyContent:'center', marginBottom:'10px'}}>
